  ...
  return (
    <nav className="w-full backdrop-blur-md z-50 fixed h-24 flex justify-between items-center py-8 px-4 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
      ...
      <div className="hidden md:flex gap-4 items-center">
        <Link
          href={
            process.env.NEXT_PUBLIC_GITHUB_URL || 'https://github.com/SkaiLord/'
          }
        >
          <Button
            variant="default"
            className="rounded-full w-fit gap-2 items-center hidden md:flex p-2"
            size="lg"
          >
              ...
              <div className="w-full space-y-3">
                ...
                <div className="flex gap-4 items-center justify-center">
                  ...
                  >
                    <Button
                      variant="default"
                      className="rounded-full w-fit items-center flex p-2"
                      size="sm"
                    >
